...
cardDict = {
    ...
    "emperor" : "masculin energy, head of community, solid foundation to build",
    ...
    "justice" : "cause and effect, to be fair to achieve the best result",
    "hanged man" : "temporarily suspended, life is on hold but serves a purpose",
    "death" : "transformation, things will not be the same again",
    ...
    "world" : "your life lessons have made you smart and accomplished"
}
